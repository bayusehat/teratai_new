...
<?php  } ?>
<form action="<?= base_url();?>retur_pembelian/insert/<?= $this->uri->segment(3);?>" method="POST">
    <div id="content-wrapper" class="group">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-6">
                    <a href="<?= base_url('retur_pembelian/list_retur/'.$this->uri->segment(3));?>" class="btn btn-danger mb-5"><i class="fa fa-arrow-left"></i> Kembali</a>
                </div>
            </div>
            <?php
