...
<?php  } ?>
<form action="<?= base_url();?>retur_penjualan/update/<?= $this->uri->segment(3);?>" method="POST">
    <div id="content-wrapper" class="group">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-6">
                    <a href="<?= base_url('retur_penjualan/list_retur/'.$retur->id_penjualan);?>" class="btn btn-danger mb-5"><i class="fa fa-arrow-left"></i> Kembali</a>
                </div>
            </div>
            <?php
                                ...
                                <select name="id_customer" id="id_customer" class="form-control input-sm select2">
                                    ...
                                    <!-- <?php
                                        foreach($customer as $sp){ ?>
                                            <option value="<?= $sp->id_customer;?>" <?php if($retur->id_customer == $sp->id_customer){echo 'selected';}else{echo '';}?>><?= $sp->nama_customer;?></option>
                                    <?php    }
                                    ?> -->
                                    <?php
                                        // foreach($customer as $sp){ ?>
                                            ...
                                            <?php
                                                ...
                                                foreach($detail as $dp){ ?>
                                                    <tr>
                                                        ...
                                                        <td><input type="text" class="form-control" name="catatan[]" value="catatn"></td>
                                                        <td>
