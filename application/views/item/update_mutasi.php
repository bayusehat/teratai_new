...
<form action="<?= base_url();?>item/doUpdateMutasi/<?= $mutasi->id_mutasi;?>" method="POST">
                    ...
                    <div class="col-sm-6 col-md-6 col-xl-6">
                        ...
                        <?php  } ?>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control pickdate" name="tanggal_mutasi" id="tanggal_mutasi" value="<?= date('Y-m-d',strtotime($mutasi->tanggal_mutasi));?>" placeholder="Tanggal Mutasi">
                            </div>
                            <div class="form-group">
                               <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="gudang_asal" id="gudang_asal" class="form-control">
                                                ...
                                                <?php
                                                    ...
                                                    ?>
                                                    <option value="<?= $ga->id_gudang;?>" <?php if($mutasi->gudang_asal == $ga->id_gudang){echo 'selected';}else {echo '';}?>><?= $ga->nama_gudang;?></option>
                                                <?php    
                                                    }
                                                ?>
                                            </select>
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xl-12">
                                        <div class="form-group">
                                            ...
                                            <select name="gudang_tujuan" id="gudang_tujuan" class="form-control">
                                                ...
                                                ?>
                                                    <option value="<?= $gt->id_gudang;?>" <?php if($mutasi->gudang_tujuan == $gt->id_gudang){echo 'selected';}else {echo '';}?>><?= $gt->id_gudang;?></option>
                                                <?php    
                                                    }
                                                ?>
                                            </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="catatan" id="catatan" class="form-control" style="margin: 0px 548px 0px 0px; width: 519px; height: 68px;" cols="30" rows="10"><?= $mutasi->catatan;?></textarea>
                            </div>
                        </div>
                        ...
                        <hr>
                                        ...
                                        <tbody id="listItem">
                                          ...
                                          <?php
                                            foreach($detail as $dt){ ?>
                                                <tr>
                                                    <td>
                                                        <input type="hidden" name="id_item[]" value="<?= $dt->id_item;?>">
                                                        <?= $dt->nama_item;?>
                                                    </td>
                                                    <td>
                                                        <input type="text" class="form-control input-sm" name="quantity[]" value="<?= $dt->quantity;?>">
                                                    </td>
                                                    <td>
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-warning btn-block"><i class="fa fa-save"></i> Update Mutasi</button>
                            </div>
                        </div>
                    </div>
                </div>
